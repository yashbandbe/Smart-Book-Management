...
<body>
   <input type="hidden" id="status" value="<%= request.getAttribute("status")%>">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
			...
			<div class="collapse navbar-collapse " id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto  ">
					...
					<li class="nav-item active"><a class="nav-link" href="viewissuebooks.jsp">
							<i class="fa-solid fa-book-open-reader m-1"></i></i>Issue Books <span class="sr-only">(current)</span>
					</a></li>
    ...
    <div align="center" style="display: flex; flex-wrap: wrap;">
        ...
        <img src="C:\Users\siddh\eclipse-workspace\loginpage\src\main\webapp\Images" alt="Book Cover" />
    </div>
            <div class="book-info">
